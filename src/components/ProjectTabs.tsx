  ...
  const projects = [
    {
      ...
      description: "Statistical analysis of Oscar nomination patterns and win probabilities across genre-category combinations using advanced data science techniques",
      ...
      details: "Comprehensive study analyzing 15+ years of Academy Awards data to identify strategic advantages for film positioning and award campaign optimization."
    },
    {
      id: "skillset-network",
      title: "Interactive Skillset Network Diagram",
      shortTitle: "Skillset Network",
      description: "Dynamic visualization mapping skillsets based on GitHub project topics, with automated daily updates and interactive exploration features",
      tagline: "Data Visualization",
      technologies: ["Python", "D3.js", "GitHub API", "Data Visualization", "Automation"],
      icon: Network,
      link: "/skillset-network",
      details: "Automated system that scans GitHub repositories to create visual network diagrams showing skill relationships and expertise areas."
    },
    {
      id: "sbc-workflow",
      ...
      icon: Users,
      link: "/sbc-workflow",
      details: "Created BPMN diagram to clarify decision points and workflows between student businesses, the university, and external reviewers. Currently being implemented in pilot."
    }
  ];
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {projects[activeProject].technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-slate-100 text-slate-700 text-sm rounded-full border"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex flex-wrap gap-3">
                  <Button 
                    onClick={() => handleViewDetails(projects[activeProject].link)}
                    className="flex items-center space-x-2"
                  >
